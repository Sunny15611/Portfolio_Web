...
// import { motion } from 'framer-motion';
// import { Code2, PenTool as Tool, Users, Brain, Server, Book } from 'lucide-react';
...
//   "Backend & Cloud": {
//     icon: Server,
//     skills: ['RestAPi',"FastAPI", "Spring Boot", "Flask", "Redis", "AWS S3",'MongoDB', 'MySql',"Qdrant VDB", "Pinecone","Elasticsearch", "Postman"]
//   },
//   "Tools & Libraries": {
//     icon: Tool,
//     skills: ["Git", "CUDA", "Pydantic Model", "NumPy", "Pandas", "Matplotlib", "Seaborn", "LaTeX"]
//   },
//   "Concepts & Areas of Expertise": {
//     icon: Book,
//     skills: ['Agentic AI',"Data Structures & Algorithms", "Object-Oriented Programming", "Vector DB", "RAG", "Fine-Tuning LLMs"]
//   },
//   "Soft Skills": {
//     icon: Users,
//     skills: ["Leadership", "Event Management", "Teamwork", "Presentation Skills"]
//   }
// };
